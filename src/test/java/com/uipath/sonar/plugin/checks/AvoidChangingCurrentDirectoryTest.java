...
public class AvoidChangingCurrentDirectoryTest {

    private AvoidChangingCurrentDirectory check;
    ...
    public void setUp() throws Exception {
        check = new AvoidChangingCurrentDirectory();
        project = LoadProject.withPath("AvoidChangingCurrentDirectory");
